...
export const AIAnswerSchema = z.object({
  ...
  content: z.string().min(100, {
    message: "Question description must have a minimum of 100 characters.",
  }),
...
export const ProfileSchema = z.object({
  ...
  username: z.string().min(3, { message: "Username must not be longer than 100 characters." }),
  portfolio: z.url({ message: "Please provide a valid URL." }),
